        ...
        <div className="space-y-6">
          ...
          <div className="bg-white/80 rounded-2xl p-6 shadow-sm border border-slate-100 text-center relative overflow-hidden group">
            ...
            <button
              ...
              className="w-full py-2.5 bg-[#4A70A9] hover:bg-[#3b5d8f] text-white rounded-xl font-semibold transition shadow-sm active:scale-[0.98]"
            >
              Edit Profile
            </button>
          </div>
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="border border-slate-100 rounded-xl p-4">
              <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-500 flex items-center gap-2">
                            {user?.email}
                            <button onClick={copyEmail} className="p-1 hover:bg-slate-100 rounded-md transition text-slate-400 hover:text-slate-600" title="Salin">
                ...
                <button
                  ...
                  className="px-4 py-2 border border-slate-200 hover:border-[#4A70A9] hover:text-[#4A70A9] rounded-xl text-sm font-medium transition bg-white"
                >
                  Ganti Email
                </button>
              </div>
          ...
          >
            ...
            <button
              ...
              className="px-6 py-3 bg-white/20 hover:bg-white/30 backdrop-blur-sm rounded-xl font-semibold transition flex items-center gap-2"
            >

    ...
    <AnimatePresence>
      {!exiting && (
        <motion.section
          ...
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }} // <---- Fade out before leaving
          transition={{ duration: 0.6, ease: "easeInOut" }}
          className="relative w-full min-h-screen flex items-center justify-center bg-linear-to-br from-[#E8EEF5] via-[#C8D9EA] to-[#9AB8D4] overflow-hidden"
        >
          {/* Floating blurred shapes */}
          <div className="absolute -top-32 -left-24 w-[360px] h-[360px] bg-white/30 blur-3xl rounded-full opacity-60 animate-pulse"></div>
          <div className="absolute bottom-0 right-0 w-[420px] h-[420px] bg-[#AEC7DE]/40 blur-3xl rounded-full opacity-50 animate-pulse"></div>

          {/* Content */}
          <div className="relative z-20 w-full max-w-6xl px-6 md:px-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="flex flex-col gap-8">
              <div className="px-6 py-2 w-fit flex items-center gap-2 rounded-full bg-white/30 backdrop-blur-md border border-white/40 shadow-sm text-[#2F3A4B] font-medium">
                <LogInIcon className="w-4 h-4 stroke-[#2F3A4B]" />
              ...
              >
                Produktivitas, <br />
                <span className="text-[#3B6A9E]">yang Lebih Personal.</span>
              </motion.h1>
              ...
              >
                Jurnify membantu kamu menyusun aktivitas harian, melacak
                progress, dan membangun kebiasaan yang konsisten. Semuanya
            ...
            >
              <h2 className="text-3xl font-bold text-[#2F3A4B] mb-8">Masuk</h2>
